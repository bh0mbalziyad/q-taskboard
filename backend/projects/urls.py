...
from .views import ProjectListCreateView, ProjectDetailView, TaskListCreateView, TaskDetailView, ExportView, MemberAddView, TaskCommentListView
...
urlpatterns = [
    ...
    path('tasks/<uuid:task_id>/comments', TaskCommentListView.as_view()),
]
